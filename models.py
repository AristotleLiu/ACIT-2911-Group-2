...
class Animal(db.Model):
    """
    Represents an animal entity in the database.
    """
    ...
    def to_dict(self):
        ...
        Returns:
            dict: A dictionary containing the attributes of the Animal object.
        """
        animal_dict = {
            "id": self.id,
            "name": self.name,
...
class Invoice(db.Model):
    ...
    def to_dict(self):
        ...
        Returns:
            dict: A dictionary containing the attributes of the Invoice object.
        """
        order_dict = {
            "id": self.id,
            "status": self.status,
        ...
        for item in self.animals:
            order_dict["animals"].append(
                {
                    "animal_id": item.animal_id,
                    "animal_name": item.animal.name,
                    "animal_species": item.animal.species,
                    "animal_price": item.animal.price,
                }
            )
...
class AnimalInvoice(db.Model):
    """
    Represents the association between an animal and an invoice in the database.
    """
